...
// paso (ver comentario junto a la funcion en _helpers.php). Se corre sobre
// toda la tabla (no solo las de este docente) para que quede consistente
// sin importar por donde entre alguien primero.
