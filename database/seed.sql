...
FROM (
  SELECT
    ...
    'Diseno y Desarrollo de Software' AS programa,
    'Capacitacion orientada a fortalecer la ensenanza de HTML, CSS, JavaScript y buenas practicas de codigo en proyectos formativos.' AS descripcion,
  ...
  SELECT
    ...
    'Docente formadora con experiencia en diseno curricular y evaluacion por competencias.',
  ...
  SELECT
    ...
    '["IA educativa","Diseno de materiales","Uso responsable"]',
